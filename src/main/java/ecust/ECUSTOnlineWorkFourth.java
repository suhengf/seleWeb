 ...
 **/
public class ECUSTOnlineWorkFourth {
	private static org.slf4j.Logger logger = LoggerFactory.getLogger(ECUSTOnlineWorkFourth.class);

	private ThreadPoolExecutor executor = new ThreadPoolExecutor(1,3,60L, TimeUnit.SECONDS,new LinkedBlockingDeque<>(200));
    ...
    public static void main(String[] args) throws Exception  {
        ...
        //解析得到 对应的学生名单
		FileParse.readSaveList2(userInfoList,"D:\\file\\est\\3-6.txt");
		//批量处理 学生信息
		int count = 2;
		ECUSTOnlineWorkFourth ecustOnlineWork = new ECUSTOnlineWorkFourth();
