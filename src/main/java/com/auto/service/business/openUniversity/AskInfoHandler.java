...
//    }
    ...
    public static void singleHandler(UserInfo userInfo, ChromeOptions options) throws Exception {
        ...
        String url = "https://www.oucbx.com/OUCWEB/LEAP/Web/html/home.html";
        WebDriver driver = new ChromeDriver(options);
        driver.manage().window().maximize();
        driver.get(url);
        Thread.sleep(5000);
        driver.findElement(By.xpath("/html/body/div/div[1]/div[1]/div/div/span[3]")).click();
        Thread.sleep(5000);

        driver.findElement(By.xpath("/html/body/div/div[1]/div/div[2]/div/div[1]/div[2]/div[1]/div[1]/div[1]/input")).sendKeys(userInfo.getUserId());
        Thread.sleep(5000);
        driver.findElement(By.xpath("/html/body/div/div[1]/div/div[2]/div/div[1]/div[2]/div[1]/div[2]/div[1]/input")).sendKeys(userInfo.getPassword());
        logger.info("current userId：" + userInfo.getUserId());
        String verifyCode = recognize(elementSnapshot(driver,url));
        logger.info("verifyCode：" + verifyCode);
        Thread.sleep(5000);
        driver.findElement(By.xpath("/html/body/div/div[1]/div/div[2]/div/div[1]/div[2]/div[1]/div[3]/div[1]/input")).sendKeys(verifyCode);

        //点击确定
        driver.findElement(By.xpath("/html/body/div/div[1]/div/div[2]/div/div[1]/div[2]/div[1]/button")).click();
        Thread.sleep(8000);
...
//            AtomicInteger firstStrct = new AtomicInteger(1);
//            while(true){
//                logger.info("firstStrct:"+firstStrct);
//                driver.findElement(By.xpath("/html/body/div[2]/div[3]/div[1]/div[2]/span")).click();
