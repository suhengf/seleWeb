package com.auto.service.business.commTest;


import com.auto.entity.UserInfo;
import com.auto.utils.QRtool;
import com.auto.utils.WebDriverUtils;
import com.auto.utils.WriteToFile;
...
public class AskInfoHandler {
    ...
    public static void singleHandler(UserInfo userInfo,int count) throws Exception {
        ...
        try {
            ...
            Thread.sleep(20000);
            //验证码验证
        String verifyCode = QRtool.recognize(QRtool.elementSnapshot(driver,url));
        ...
        //点击确定
            ...
            WriteToFile.readTxtFile(sb.toString(), new File("src\\main\\files\\error_0.txt"));
        }
        driver.quit();
