 ...
 **/
public class ECUSTOnlineWorkSec {
	private static org.slf4j.Logger logger = LoggerFactory.getLogger(ECUSTOnlineWorkSec.class);
    ...
    public static void main(String[] args) throws Exception  {
        ...
        //解析得到 对应的学生名单
		FileParse.readSaveList(userInfoList,"D:\\file\\est\\huali1.txt");
		//批量处理 学生信息
		int count = 4;
