...
public class ECUSTAskInfo {
	...
	private ThreadPoolExecutor executor = new ThreadPoolExecutor(2,4,60L, TimeUnit.SECONDS,new LinkedBlockingDeque<>(200));
    ...
    public static void main(String[] args) throws Exception  {
        ...
        //解析得到 对应的学生名单
		FileParse.readSaveList2(userInfoList,"src\\main\\files\\20210124_0.txt");
		//批量处理 学生信息
		int count = 4;
