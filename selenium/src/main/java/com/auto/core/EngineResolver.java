...
public class EngineResolver implements InitializingBean, ApplicationContextAware {
    ...
    public void afterPropertiesSet() {
        OrderController orderController = (OrderController) applicationContext.getBean(OrderController.class);
        Map<String, EngineExecutor> beanMap = applicationContext.getBeansOfType(EngineExecutor.class);

        String[] beanNamesForType = applicationContext.getBeanNamesForType(EngineExecutor.class);
